...
import Addproject from './components/dashboard/AdminPages/AllProjects'
import AllUser from './components/dashboard/AdminPages/AllUser';
import Addcourse from './components/dashboard/AdminPages/AllCourses';
import AddPublication from './components/dashboard/AdminPages/AllPublications';
import AddIntroduction from './components/dashboard/AdminPages/AddIntroduction';
...
import AllPublications from './components/dashboard/AdminPages/AllPublications';
import AllProjects from './components/dashboard/AdminPages/AllProjects';
    ...
    <>
      ...
      <UserState>
        ...
        <Routes onUpdate={() => window.scrollTo(0, 0)}>
          ...
          <Route exact path="/admins" element={<Login />} />
          ...
          {/* <Route element={<PrivateRoute />} > */}
            <Route Route path="/admin" element={<Admin />} >
              <Route path="add-project" element={<AllProjects />} />
              <Route path="add-course" element={<Addcourse />} />
              <Route path="add-publication" element={<AllPublications />} />
              <Route path="add-introduction" element={<AddIntroduction />} />
